                        ...
                        <div class="form-validation">
                            ...
                            <form class="form-valide" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-skill">Delivery Status <span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <select class="form-control" id="val-skill" name="status" required>
                                            <option value="<?php echo $delivery['status'] ?>">
                                                <?php echo $delivery['status'] ?></option>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-username">Date At <span
                                            class="text-danger">*</span>
                                    </label>
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" placeholder="<?php echo $delivery['shipping_date'] ?>"  value="<?php echo $delivery['shipping_date'] ?>" name="date"
                                            id="mdate" required>
                                    </div>
                                    <?php }elseif($delivery['status']=='delivered_date'){ ?>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" placeholder="<?php echo $delivery['delivered_date'] ?>"  value="<?php echo $delivery['delivered_date'] ?>" name="date"
                                            id="mdate" required>
                                    </div>
                                    <?php } ?>
