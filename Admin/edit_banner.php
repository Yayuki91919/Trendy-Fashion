<?php 
    ...
    if(isset($_GET['banner_id'])){
        ...
        $sub_value=$sub_controllor->getSubCategory($banner['sub_id']);
    }
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            ...
                            <form id="bannerForm" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="val-skill" name="sub" required>
                                            <option value="<?php echo $banner['sub_id'] ?>">
                                                <?php echo $sub_value['brand_name'] ?></option>
                                            <?php 
                                            $subs = $sub_controllor->getSubCategories();
                                            foreach ($subs as $s) { ?>
                                            <option value="<?php echo $s['sub_id']; ?>"><?php echo $s['brand_name']; ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 ">
                                        <input type="text" class="form-control" placeholder="Banner's Title"
                                            value="<?php echo $banner['title'] ?>" name="title" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="img-preview">
                                            ...
                                            <img src="images/banner_photo/<?php echo $array ?>"
                                                alt="<?php echo $array ?>">
                                            <?php } ?>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 ">
                                        <input type="text" class="form-control" placeholder="Banner's Title"
                                            value="<?php echo $title ?>" name="title" required>
                                        <?php if (isset($errors['title'])): ?>
                                        <div class="error"><?php echo $errors['title']; ?></div>
                                        <?php endif; ?>
                                    </div>
