...
$shop_controller = new ShopInfoController();
    $name=$phone=$viber=$address=$open=$close="";
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $open=$_POST['open'];
    $close=$_POST['close'];
    $result = $shop_controller->addShopInfo($name,$phone,$viber,$address,$open,$close);
    if ($result) {
        $message = 1;
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class=" mb-3">Create Shop Information</h2>
                        <div class="form-validation">
                            <form class="form-valide" action="new_shop.php" method="post">
